...
- **Reject hidden or nested solution Markdown with guidance that separates the flat Agent Workflows lesson schema from consumer-repository Compound Engineering destinations.**

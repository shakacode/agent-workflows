...
New human maintainer waivers begin with a visible outcome and contain one closed
`QA waiver details` disclosure with a fenced `qa-maintainer-waiver v1` record
for those fields. Historical `<!-- qa-maintainer-waiver v1 ... -->` forms are

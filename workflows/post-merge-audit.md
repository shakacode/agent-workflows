...
- In completed-batch mode only:
  - Apply [Audit applicability](pr-batch-integration-closeout.md#audit-applicability) before requiring this audit. The batch coordinator owns a required completed-batch audit and its final handoff; a parent only reconciles the durable audit handoff.

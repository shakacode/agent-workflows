...
- In completed-batch mode only:
  ...
  - Put `What changed:`, `Action needed:`, and `Next:` before the compact receipt so the receipt can open the closing lines before the optional Unblock Block and the final `Conversation status:` line.

...
blocks, advisory `codex-claim` rows, and PR range before deep audit. Proceed
without another confirmation when the just-run batch was obvious in the current
visible chat and verification did not surface conflicting scope evidence. When

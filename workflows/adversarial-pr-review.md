...
gh pr diff <PR>
# Bind TRUSTED_PR_BATCH_SKILL_DIR to an exact trusted-base materialization outside
# the candidate checkout or an independently digest-verified installed pack.

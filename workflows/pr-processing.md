...
merge iff `merge_authority` is `auto_merge_when_gates_pass`|explicit merge approval;document confidence data in PR description
...
the declaration helper. Do not report coordination as unavailable or degraded.

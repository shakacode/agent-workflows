...
class AgentWorkflowsOperationTest < Minitest::Test
  ...
  def create_source_repository
    ...
    system("git", "-C", @source, "config", "gc.auto", "0", exception: true)
    system("git", "-C", @source, "config", "gc.autoDetach", "false", exception: true)
    system("git", "-C", @source, "config", "maintenance.auto", "false", exception: true)

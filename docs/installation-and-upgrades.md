...
and `managed_pack_root_copy_fingerprints`, including every installed
prompt-compatibility contract, schema, and `<target>/docs/solutions/*`
document, plus the third-party notice. On repeat installation, these
fingerprints

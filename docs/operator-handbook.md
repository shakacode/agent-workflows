...
| No-backend single-operator approval | When the configured private backend is unavailable, an ad-hoc lane needs your explicit approval before it can branch. | [Coordination State](../workflows/pr-processing.md#coordination-state) |

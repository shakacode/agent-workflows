...
| Revert decisions | A post-merge audit that flags revert consideration routes it to a follow-up issue rather than acting on it during the audit. | [Finding Classification](../skills/post-merge-audit/SKILL.md#finding-classification), [Issue Plan](../skills/post-merge-audit/SKILL.md#issue-plan) |

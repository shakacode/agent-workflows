...
Audit merged PRs after batch work or before the next release step. Use git and
GitHub ground truth, not chat memory.
...
Ask for confirmation before deep audit unless the user explicitly asks to proceed

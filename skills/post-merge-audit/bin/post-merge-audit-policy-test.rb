...
class PostMergeAuditPolicyTest < Minitest::Test
  ...
  REQUIRED_APPLICABILITY_SELECTED_PREFLIGHT_INPUT = "Before preflight, record trusted `coordination_applicability`; for `coordination_required`, capture fresh bounded exact-batch coordination status, while for `coordination_not_applicable`, supply the typed single-controller proof without any coordination command."

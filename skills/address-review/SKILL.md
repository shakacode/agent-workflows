...
The review-data helper requires the absolute trust-config path, global-or-
repository scope, and content digest emitted by trusted-base preflight. It
...
`--trust-config-scope`, and `--expected-trust-digest`.

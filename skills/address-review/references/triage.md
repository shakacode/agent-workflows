...
- An inline comment carrying `root_excluded: true` is a trusted reply whose top-level comment was excluded. Triage it as its own item; its root will not appear in `inline_comments`.

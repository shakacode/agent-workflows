...
assert(prompt_intake.include?("Lane Card:claim/PR-open/block/cancel/final;route;holder/branch/PR/phase/URLs/UNKNOWN"), "canonical intake must preserve the durable Lane Card grammar")

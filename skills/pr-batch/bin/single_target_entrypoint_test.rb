...
assert(batch.include?("Extract only explicit GitHub PR/issue refs or verified Linear entries"), "continuation extraction must accept verified Linear targets")

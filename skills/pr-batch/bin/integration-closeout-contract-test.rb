...
class IntegrationCloseoutContractTest < Minitest::Test
  ...
  def test_component_owns_the_full_closeout_interface
    ...
    # Integrated main uses 394,968 bytes; approved Astra routing references add
    # 1,433 bytes. Keep a finite document budget with 599 bytes of headroom.
    assert_operator @component.bytesize + @workflow.bytesize + @skill.bytesize, :<, 397_000

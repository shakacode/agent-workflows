...
class IntegrationCloseoutContractTest < Minitest::Test
  ...
  def test_component_owns_the_full_closeout_interface
    ...
    assert_operator combined_ceiling - combined_size, :>=, 1_000,

...
LAUNCH_ASSURANCE_PROMPT_LINE = "Launch assurance: parent <exact model>/<effort>@<binding source>; checker <exact model>/<effort>; UNKNOWN blocks."
...
MODEL_EFFORT_DISPATCH_LINE = "- Verify launch assurance and bind worker routes on actual hosts; prompt cannot change parent; no inheritance/substitution; mismatch/UNKNOWN -> stop/relaunch."
...
host_aware_batch_sizing_phrase_checks = {
  ...
  "skills/triage/SKILL.md" => [
    ...
    ["`Launch assurance: parent <exact model>/<effort>@<binding source>; checker <exact model>/<effort>; UNKNOWN blocks.`", 1],

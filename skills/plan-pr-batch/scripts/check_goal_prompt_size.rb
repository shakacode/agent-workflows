...
OBSERVED_HOST_PROMPT_LINE = "Observed host/model/effort:<host|UNKNOWN>/<model|UNKNOWN>/<effort|UNKNOWN>."
...
MIXED_DISPATCH_POLICY_LINES = <<~TEXT.chomp
  Dispatch implementation:prefer remote@balanced/medium;fallback remote@strongest/high;auth=y;pending/active.
  Dispatch qa-review:prefer remote@strongest/high;fallback none;auth=n;pending/active.
TEXT

...
3. Shape
   ...
   - Model/effort routing: keep the coordinator model/effort preference
     ...
     worker only after the preflight accepts the path as disjoint. Under
     ...
     it must also be present in `launch.eligible_lane_ids`. The reservation persists until the
